...
@section('content')
                    ...
                    <div class="main-post">
                        ...
                        <div class="blog-post-inner">
                            ...
                            <div class="post-info">
                                ...
                                <div class="left-area">
                                    <a class="avatar" href="#"><img src="{{ Storage::disk('public')->url('profile/'.$post->user->image) }}" alt="Photo de profile"></a>
                                </div>

                                <div class="middle-area">
                                    <a class="name" href="#"><b>{{ $post->user->name }}</b></a>
                                    <h6 class="date">sur {{ $post->created_at->diffForHumans() }}</h6>
                                </div>
                        ...
                        <div class="post-icons-area">
                            <ul class="post-icons">
                                <li>
                                    @guest
                                        <a href="javascript:void(0);" onclick="toastr.info('Connectez-vous pour ajouter des favoris à votre liste.','Info',{
                                                    closeButton: true,
                                                    progressBar: true,
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card h-100">
                            <div class="single-post post-style-1">
                                ...
                                <a class="avatar" href="#"><img src="{{ Storage::disk('public')->url('profile/'.$randompost->user->image) }}" alt="Photo de profile"></a>
    ...
    <section class="comment-section">
        <div class="container">
            <h4><b>Commentaire(s) de post</b></h4>
            <div class="row">

                <div class="col-lg-8 col-md-12">
                    <div class="comment-form">
                        @guest
                            <p>Connectez-vous pour poster un nouveau commentaire. <a href="{{ route('login') }}">Connexion</a></p>
                        @else
                            <form method="post" action="{{ route('comment.store',$post->id) }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <button class="submit-btn" type="submit" id="form-submit"><b>Ajouter le commentaire</b></button>
                                    </div><!-- col-sm-12 -->
                            ...
                            <div class="commnets-area ">
                                ...
                                <div class="comment">
                                    ...
                                    <div class="post-info">
                                        ...
                                        <div class="left-area">
                                            <a class="avatar" href="#"><img src="{{ Storage::disk('public')->url('profile/'.$comment->user->image) }}" alt="Image de profile"></a>
                                        </div>
                    ...
                    <div class="commnets-area ">
                        ...
                        <div class="comment">
                            <p>AUcun commentaire soyez le premier à enfaire un 😊 :)</p>
                    </div>
                    </div>
