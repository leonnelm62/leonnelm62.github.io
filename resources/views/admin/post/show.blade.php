                ...
                <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                              {{ $post->title }}
                                <small>Publié par <strong> <a href="">{{ $post->user->name }}</a></strong> le {{ $post->created_at->toFormattedDateString() }}</small>
                            </h2>
                        </div>
                        <div class="body">
                            {!! $post->body !!}
    ...
    <script>
        ...
        function approvePost(id) {
            swal({
                ...
                confirmButtonText: 'Oui, j\'approuvez!',
