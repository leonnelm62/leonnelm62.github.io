                    ...
                    <div class="card">
                        ...
                        <div class="body">
                                ...
                                <div class="form-group">
                                    <label for="image">Image vedette</label>
                        ...
                        <div class="body">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line {{ $errors->has('tags') ? 'focused error' : '' }}">
                                    <label for="tag">Selectionez un Tags</label>
                            ...
                            <a  class="btn btn-danger m-t-15 waves-effect" href="{{ route('author.post.index') }}">RETOUR</a>
