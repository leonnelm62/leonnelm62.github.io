                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                <thead>
                                <tr>
                                    <th class="text-center">Info commentaires</th>
                                    <th class="text-center">Info Post</th>
                                            ...
                                            <td>
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <p>{{ $comment->comment }}</p>
                                                        <a target="_blank" href="{{ route('post.details',$comment->post->slug.'#comments') }}">Répndre</a>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <p>par <strong>{{ $comment->post->user->name }}</strong></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
