                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="card h-100">
                                    <div class="single-post post-style-1">
                                        ...
                                        <a class="avatar" href="{{ route('author.profile',$post->user->username) }}"><img src="{{ Storage::disk('public')->url('profile/'.$post->user->image) }}" alt="Image de profile"></a>
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="card h-100">
                                    <div class="single-post post-style-1">
                                        <div class="blog-info">
                                            <h4 class="title">
                                                <strong>Désolé aucun post trouvé :(</strong>
                                            </h4>
                                        </div><!-- blog-info -->
                                    </div><!-- single-post -->
                                </div><!-- card -->
                ...
                <div class="col-lg-4 col-md-12 ">
                    ...
                    <div class="single-post info-area ">
                        ...
                        <div class="about-area">
                            ...
                            <p>{{ $author->name }}</p><br>
                            <p>{{ $author->about }}</p><br>
                            <strong>AUTEUR DEPUIS: {{ $author->created_at->toDateString() }}</strong><br>
                            <strong>TOTAL DE POST : {{ $author->posts->count() }}</strong>
                        </div>
